import logo from '../img/favicons/vox-scout-nobg-94x94.png';


const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-sky-200 text-gray-950">
        <div className="container flex flex-col justify-between py-10 max-w-7xl mx-auto  space-y-8 lg:flex-row lg:space-y-0">
            ...
            <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                ...
                <div className="space-y-3">
                    <div className="uppercase text-gray-950">Social media</div>
